...
import 'package:code_bolanon/models/course_model.dart' as _i33;
import 'package:code_bolanon/models/lessons_model.dart' as _i34;
import 'package:code_bolanon/models/payment_param.dart' as _i35;
...
class Routes {
  ...
  static const rescheduleAppointmentView = '/reschedule-appointment-view';
...
class StackedRouter extends _i1.RouterBase {
  final _routes = <_i1.RouteDef>[
    ...
    _i1.RouteDef(
      Routes.rescheduleAppointmentView,
      page: _i31.RescheduleAppointmentView,
    ),
  ];
  ...
  final _pagesMap = <Type, _i1.StackedRouteFactory>{
    ...
    _i28.AppointmentDetailsView: (data) {
      final args = data.getArgs<AppointmentDetailsViewArguments>(nullOk: false);
      return _i32.MaterialPageRoute<dynamic>(
        builder: (context) => _i28.AppointmentDetailsView(
            key: args.key, appointmentId: args.appointmentId),
        settings: data,
      );
    },
    ...
    _i31.RescheduleAppointmentView: (data) {
      final args =
          data.getArgs<RescheduleAppointmentViewArguments>(nullOk: false);
      return _i32.MaterialPageRoute<dynamic>(
        builder: (context) => _i31.RescheduleAppointmentView(
            key: args.key,
...
class PaymentViewArguments {
  ...
  final _i35.PaymentParam payment;
...
class AppointmentDetailsViewArguments {
  ...
  @override
  String toString() {
    return '{"key": "$key", "appointmentId": "$appointmentId"}';
  }

  @override
  bool operator ==(covariant AppointmentDetailsViewArguments other) {
    if (identical(this, other)) return true;
    return other.key == key && other.appointmentId == appointmentId;
  }

  @override
  int get hashCode {
    return key.hashCode ^ appointmentId.hashCode;
  }
}
...
class RescheduleAppointmentViewArguments {
  const RescheduleAppointmentViewArguments({
    this.key,
    required this.appointmentId,
    this.isEdit = false,
    this.onClose,
  ...
  @override
  String toString() {
    return '{"key": "$key", "appointmentId": "$appointmentId", "isEdit": "$isEdit", "onClose": "$onClose"}';
  }

  @override
  bool operator ==(covariant RescheduleAppointmentViewArguments other) {
    if (identical(this, other)) return true;
...
extension NavigatorStateExtension on _i36.NavigationService {
  ...
  Future<dynamic> navigateToPaymentView({
    _i32.Key? key,
    required _i35.PaymentParam payment,
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
  ...
  Future<dynamic> navigateToManageStackView([
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
    ...
    return navigateTo<dynamic>(Routes.manageStackView,
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
  ...
  Future<dynamic> navigateToAppointmentDetailsView({
    ...
    return navigateTo<dynamic>(Routes.appointmentDetailsView,
        arguments: AppointmentDetailsViewArguments(
            key: key, appointmentId: appointmentId),
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
  ...
  Future<dynamic> navigateToRescheduleAppointmentView({
    _i32.Key? key,
    required String appointmentId,
    bool isEdit = false,
    ...
    return navigateTo<dynamic>(Routes.rescheduleAppointmentView,
        arguments: RescheduleAppointmentViewArguments(
            key: key,
  ...
  Future<dynamic> replaceWithManageStackView([
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
  ...
  Future<dynamic> replaceWithRescheduleAppointmentView({
    _i32.Key? key,
    required String appointmentId,
    bool isEdit = false,
    void Function()? onClose,
    ...
    return replaceWith<dynamic>(Routes.rescheduleAppointmentView,
        arguments: RescheduleAppointmentViewArguments(
            key: key,
            appointmentId: appointmentId,
            isEdit: isEdit,
