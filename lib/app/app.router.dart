...
import 'package:code_bolanon/models/course_model.dart' as _i22;
import 'package:code_bolanon/models/course_param.dart' as _i24;
import 'package:code_bolanon/models/lessons_model.dart' as _i23;
...
extension NavigatorStateExtension on _i25.NavigationService {
  ...
  Future<dynamic> navigateToPaymentView({
    _i21.Key? key,
    required _i24.CourseParam course,
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
